...
description: |
  ...
  触发词: /asyre-graphic, 社媒, 小红书, 做卡片, 排版, 信息图, XHS, RedNote, 内容卡片
user-invocable: true
---
...
/asyre-graphic --mode=ai --style=notion --preset=knowledge-card
/asyre-graphic --brand=mojin                          # Use brand
/asyre-graphic article.md --yes                      # Non-interactive, skip confirmations
```
...
3. XDG config: `$XDG_CONFIG_HOME/asyre-graphic/EXTEND.md`
4. 用户级: `~/.asyre-graphic/EXTEND.md`
...
```
{output_root}/asyre-graphic/{topic-slug}/
