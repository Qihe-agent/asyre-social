...
```bash
/asyre-graphic [主题或内容]                           # 自动检测模式
/asyre-graphic article.md --mode=text                 # 强制精排版
/asyre-graphic --mode=ai --preset=knowledge-card      # AI + 预设
/asyre-graphic --brand=tuisheng                       # 指定品牌
/asyre-graphic article.md --yes                       # 非交互模式
```
